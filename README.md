...
- [PDF-версия продуктового и технического кейса](docs/JARVIS_VPN_case.pdf).
...
Ниже показаны обезличенные экраны рабочего продукта. Пользовательские идентификаторы, суммы и фактические показатели заменены или скрыты; интерфейс наполнен демонстрационными данными.
...
<table>
  ...
  <tr>
    <td><a href="assets/panel-dashboard-demo.png"><img src="assets/panel-dashboard-demo.png" alt="Демонстрационный дашборд JARVIS VPN"></a></td>
    <td><a href="assets/panel-users-demo.png"><img src="assets/panel-users-demo.png" alt="Демонстрационный экран пользователей JARVIS VPN"></a></td>
  </tr>
  <tr>
    <th>Финансовая аналитика</th>
    <th>Удержание клиентов</th>
  </tr>
  <tr>
    <td><a href="assets/panel-finance-demo.png"><img src="assets/panel-finance-demo.png" alt="Демонстрационный экран финансовой аналитики JARVIS VPN"></a></td>
    <td><a href="assets/panel-retention-demo.png"><img src="assets/panel-retention-demo.png" alt="Демонстрационный экран удержания клиентов JARVIS VPN"></a></td>
  </tr>
</table>

## Пользовательский сценарий в Telegram

Кадры ниже показывают основной интерфейс бота: главное меню, выбор платформы, управление устройствами и варианты продления. Реферальные ссылки, конфигурации подключения и идентификаторы пользователей не публикуются.

<table>
  <tr>
    <th>Главное меню</th>
    <th>Выбор платформы</th>
  </tr>
  <tr>
    <td><a href="assets/bot-main-menu.jpg"><img src="assets/bot-main-menu.jpg" alt="Главное меню Telegram-бота JARVIS VPN"></a></td>
    <td><a href="assets/bot-platform-selection.jpg"><img src="assets/bot-platform-selection.jpg" alt="Выбор платформы в Telegram-боте JARVIS VPN"></a></td>
  </tr>
  <tr>
    <th>Управление устройствами</th>
    <th>Баланс и продление</th>
  </tr>
  <tr>
    <td><a href="assets/bot-devices.jpg"><img src="assets/bot-devices.jpg" alt="Управление устройствами в Telegram-боте JARVIS VPN"></a></td>
    <td><a href="assets/bot-balance-plans.jpg"><img src="assets/bot-balance-plans.jpg" alt="Баланс и варианты продления в Telegram-боте JARVIS VPN"></a></td>
  </tr>
</table>

Интерфейс зафиксирован в сентябре 2026 года и продолжает развиваться. Показанные названия устройств относятся к демонстрационному аккаунту.
